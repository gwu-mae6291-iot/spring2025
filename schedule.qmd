...
<tr class="table-secondary">
      <th scope="row"> Week 8 [03/19/2025]</th>
      <td colspan="2" style="text-align: center">
          **Guest lecture:** **Designing Hardware to Improve Your Software--A Use Case in Sound** by <a href="https://www.linkedin.com/in/jakewhitton/" target="_blank">Jacob Whitton</a>, Software Engineer, Jump Trading Corp.</li> <br>
...
<tr class="table-secondary">
      <th scope="row">Week 10 [04/2/2025]</th>
      <td>
        <ul>
      ...
      <td>
        <ul>      
        <li><strong>In-class MQTT on Raspberry Pi using Paho MQTT [Graded Lab Activity]</strong></li>
        <!-- <li><strong><a href="Downloads/LastName_ExecutiveSummary.docx" style="color:red;" target="_blank">HW5: Guest Lecture Summary [Download Template]</a></strong></li> <strong>HW5 Assigned: 03/01/2024; HW5 Due: 02/08/2024</strong> -->
        </ul>
      </td>
