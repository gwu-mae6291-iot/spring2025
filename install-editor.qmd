...
Bulusu, Kartik V. (2025, January). MAE 6291: Internet-of-Things for Engineers. [Course lecture notes, codea and presentations]. Department of Mechanical and Aerospace Engineering, The George Washington University.
:::
...
- **Only Windows or Macintosh Computers with QWERTY keyboards are supported for this course.** The instructor has limited time to troubleshoot any OS-related problems.
...
- **Linux OS-based laptops / personal computers and mobile /handheld-devices are not recommended or supported this semester.**
:::
...
- **Step 4:** Download and install **[Chrome web browser](https://www.google.com/chrome/browser-tools/)**
  - Skip this step if you already have Chrome installed on your laptop.

- **Step 5:** Create a **free [ThingSpeak](https://thingspeak.com/login?skipSSOCheck=true) account**
