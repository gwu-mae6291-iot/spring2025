...
- **Step 6:** Download and install **[Chrome web browser](https://www.google.com/chrome/browser-tools/)**
  - Skip this step if you already have Chrome installed on your laptop.

- **Step 7:** Create a **free [ThingSpeak](https://thingspeak.com/login?skipSSOCheck=true) account**
