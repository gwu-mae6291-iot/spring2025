    ...
    <th scope="row">
      ...
      <td>
        <ul>
          ...
          <li>Python programming and other Homework 10% </li>
      ...
      <td>
        <ul>
         ...
         <li>Paper reviews of seleted archival journals will be required in formats provided 10% </li> 
         <li>Projects (including code, demo, written report and presentation) 50% </li>  
         <ul>
            <li>20% Midterm project (Individial)</li>
            <li>30% Final project (Individial)</li>
         </ul>   
        </ul>
      </td>
